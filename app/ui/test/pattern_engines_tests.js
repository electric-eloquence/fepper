...
exports.pattern_engines_support_functions = {
  ...
  'isPseudoPatternJSON correctly identifies pseudo-pattern JSON filenames': function (test) {
    ...
    Object.keys(filenames).forEach(function (filename) {
      ...
      var actualResult = patternEngines.isPseudoPatternJSON(filename);
      var testMessage = 'isPseudoPatternJSON should return ' + expectedResult + ' for ' + filename;
  ...
  'isPatternFile correctly identifies pattern files and rejects non-pattern files': function (test) {
    ...
    Object.keys(filenames).forEach(function (filename) {
      var expectedResult = filenames[filename];
      var actualResult = patternEngines.isPatternFile(filename);
      var testMessage = 'isPatternFile should return ' + expectedResult + ' for ' + filename;
      test.strictEqual(actualResult, expectedResult, testMessage);
    });
...
exports.pattern_engines_initialization = {
...
engineNames.forEach(function (engineName) {
  exports[engineName + '_pattern_engine'] = {
