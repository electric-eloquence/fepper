...
> DO NOT INCLUDE DIRECTORIES WITH BACKEND SOURCE CODE! WEBSERVED DIRECTORIES 
  ARE FOR STATIC ASSETS ONLY! NO BACKEND PROGRAMMING LANGUAGE WILL GET 
  PREPROCESSED! IF A STATIC SITE IS GENERATED, OR THE EXPRESS APP GETS PUBLICLY 
  SERVED, SOURCE CODE WILL BE RENDERED AS PLAIN TEXT! THIS WILL MAKE PUBLIC ANY 
  SENSITIVE INFORMATION CONTAINED WITHIN THE SOURCE CODE!
